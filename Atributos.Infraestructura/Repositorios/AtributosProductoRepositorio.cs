...
namespace Atributos.Infraestructura.Repositorios
{
    ...
    public class AtributosProductoRepositorio : IAtributosProductoRepositorio
    {
        ...
        public AtributosProductoRepositorio(IRepositorioBase<Medida> medida, IRepositorioBase<Categoria> categoria, IRepositorioBase<Marca> marca, IRepositorioBase<Color> color, IRepositorioBase<Modelo> modelo, IRepositorioBase<Material> material)
        {
            _medida = medida;
